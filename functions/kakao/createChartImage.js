module.exports = function (weightData, callback) {
    ...
    var chartNode = new ChartjsNode(360, 315);
    ...
    .then(() => {
        ...
        mkdirp(__dirname+'/../../public/charts/kakao/'+weightData.user_key, function(err){
            if (err){
                console.error("eeee",err);
                return null;
            }else {
                // write to a file
                return chartNode.writeImageToFile('image/png', './public/charts/kakao/'+weightData.user_key+'/'+chartTimestamp+'.jpeg');
            }
        });
    }).then(() => {
